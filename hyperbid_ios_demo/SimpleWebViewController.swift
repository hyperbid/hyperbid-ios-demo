...
class SimpleWebViewController: UIViewController {
    ...
    func setupItems() {
        ...
        let items = [
            ...
            UIBarButtonItem.init(barButtonSystemItem: .rewind, target: self, action: HBWebAction.goBack.action),
            UIBarButtonItem.init(barButtonSystemItem: .flexibleSpace, target: nil, action: nil),
            UIBarButtonItem.init(barButtonSystemItem: .fastForward, target: self, action: HBWebAction.goForward.action),
            UIBarButtonItem.init(barButtonSystemItem: .flexibleSpace, target: nil, action: nil),
            UIBarButtonItem.init(barButtonSystemItem: .refresh, target: self, action: HBWebAction.refresh.action),
            UIBarButtonItem.init(barButtonSystemItem: .flexibleSpace, target: nil, action: nil),
            UIBarButtonItem.init(barButtonSystemItem: .done, target: self, action: HBWebAction.close.action),
            UIBarButtonItem.init(barButtonSystemItem: .flexibleSpace, target: nil, action: nil)]
...
extension SimpleWebViewController: HBWebActionProtocol {
    func goBack() {
        self.webView.goBack()
    }
