//
//  HBAutomationTestViewController.m
//  HyperBidSDKDemo
//
...
#import "HBAutomationTestViewController.h"
#import "HBAutomationTableViewCell.h"
#import <objc/runtime.h>

@interface HBAutomationTestViewController () <UITableViewDataSource, UITableViewDelegate>
...
@implementation HBAutomationTestViewController
...
{
    HBAutomationTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:[HBAutomationTableViewCell idString]];
...
- (UITableView *)tableView
{
    if (!_tableView) {
        ...
        [_tableView registerClass:[HBAutomationTableViewCell class] forCellReuseIdentifier:[HBAutomationTableViewCell idString]];
