...
@interface HBSuspendedButton()

@property (nonatomic, strong) HBAutomationTestViewController *atomicVc;

@end

@implementation HBSuspendedButton
...
#pragma mark - lazy
- (HBAutomationTestViewController *)atomicVc
{
    if (!_atomicVc) {
        _atomicVc = [[HBAutomationTestViewController alloc] init];
