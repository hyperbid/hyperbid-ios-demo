...
@interface HBADFootView()

@end

@implementation HBADFootView
...
- (UIButton *)loadBtn
{
    if (!_loadBtn) {
        ...
        _loadBtn.layer.borderColor = mainColor.CGColor;
        _loadBtn.layer.borderWidth = kScaleW(3);
        [_loadBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateHighlighted];
        [_loadBtn setTitleColor:mainColor forState:UIControlStateNormal];
        [_loadBtn setBackgroundImage:[self imageWithColor:mainColor] forState:UIControlStateHighlighted];
...
- (UIButton *)readyBtn
{
    if (!_readyBtn) {
        ...
        _readyBtn.layer.borderColor = mainColor.CGColor;
        _readyBtn.layer.borderWidth = kScaleW(3);
        [_readyBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateHighlighted];
        [_readyBtn setTitleColor:mainColor forState:UIControlStateNormal];
        [_readyBtn setBackgroundImage:[self imageWithColor:mainColor] forState:UIControlStateHighlighted];
...
- (UIButton *)showBtn
{
    if (!_showBtn) {
        ...
        _showBtn.layer.borderColor = mainColor.CGColor;
        ...
        [_showBtn setBackgroundImage:[self imageWithColor:mainColor] forState:UIControlStateHighlighted];
...
- (UIButton *)removeBtn
{
    if (!_removeBtn) {
        ...
        _removeBtn.layer.borderColor = mainColor.CGColor;
        _removeBtn.layer.borderWidth = kScaleW(3);
        [_removeBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateHighlighted];
        [_removeBtn setTitleColor:mainColor forState:UIControlStateNormal];
        [_removeBtn setBackgroundImage:[self imageWithColor:mainColor] forState:UIControlStateHighlighted];
