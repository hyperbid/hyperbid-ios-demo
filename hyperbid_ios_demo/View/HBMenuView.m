...
#import "HBMenuView.h"
#import "HBSelectViewController.h"

@interface HBMenuView()
...
- (void)showMenuList
{
    HBSelectViewController *vc = [[HBSelectViewController alloc] initWithSelectList:self.menuList multipleSelection:self.multiple];
...
{
    HBSelectViewController *vc = [[HBSelectViewController alloc] initWithSelectList:self.subMenuList];
    __weak typeof(self) weakSelf = self;
    [vc setSelectBlock:^(NSArray * _Nonnull select) {
