...
@interface HBHomeTableViewCell()
@property (nonatomic, strong) UIView * logoBorderView;
@property (nonatomic, strong) UIView *backView;

@end

@implementation HBHomeTableViewCell
...
- (void)setSelected:(BOOL)selected animated:(BOOL)animated {
    ...
    if (selected) {
        ...
        self.logoBorderView.layer.borderColor = mainColor.CGColor;
        
        
        self.logoImage.image =  [UIImage imageNamed:self.image];
        
    }else{
        self.backView.layer.borderColor = kRGB(249, 249, 249).CGColor;
       
        self.logoBorderView.layer.borderColor =  kRGB(249, 249, 249).CGColor;
        
        self.logoImage.image =  [UIImage imageNamed:[NSString stringWithFormat:@"%@_unselect", self.image]];
